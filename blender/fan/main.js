...
(function main() {
    ...
    loadObject3D('Fan.glb').then(function (fan) {
        scene.add(fan.scene);
        fan.scene.position.z = 1;
        //rotatingGroups.push(fan.scene);
        fan.meshesToDispose.forEach(mesh => meshes.push(mesh));
        animationMixers.push(createAnimationMixer(fan));
    });
