...
(function main() {
    ...
    loadObject3D('Elephant.glb').then(function (elephant) {
        scene.add(elephant.scene);
        rotatingGroups.push(elephant.scene);
        elephant.meshesToDispose.forEach(mesh => meshes.push(mesh));
        animationMixers.push(createAnimationMixer(elephant));
    });
