...
(function main() {
    ...
    loadObject3D('Eren.glb').then(function (eren) {
        scene.add(eren.scene);
        rotatingGroups.push(eren.scene);
        eren.meshesToDispose.forEach(mesh => meshes.push(mesh));
    });
...
//loader.load('Eren.glb',function(model){
//    Eren = model;
...
//    });
//    scene.add(Eren.scene);
//    Eren.scene.position.x -= 0;
//    Eren.scene.position.z += 0;
//    window.Eren = Eren;
//    models.push(Eren);
//});
