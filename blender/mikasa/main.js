...
(function main() {
    ...
    loadObject3D('Mikasa4.glb').then(function (mikasa) {
        scene.add(mikasa.scene);
        mikasa.scene.position.y += 8.1;
        rotatingGroups.push(mikasa.scene);
        mikasa.meshesToDispose.forEach(mesh => meshes.push(mesh));
    });
