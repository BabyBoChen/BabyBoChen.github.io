...
(function main() {
    ...
    loadObject3D('Mannequin_man.glb').then(function (man) {
        scene.add(man.scene);
        rotatingGroups.push(man.scene);
        man.meshesToDispose.forEach(mesh => meshes.push(mesh));
        animationMixers.push(createAnimationMixer(man));
    });
