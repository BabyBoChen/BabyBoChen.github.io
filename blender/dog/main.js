...
(function main() {
    ...
    loadObject3D('Dog.glb').then(function (dog) {
        scene.add(dog.scene);
        rotatingGroups.push(dog.scene);
        dog.meshesToDispose.forEach(mesh => meshes.push(mesh));
        animationMixers.push(createAnimationMixer(dog));
    });
