...
(function main() {
    ...
    loadObject3D('LIHIT Shiba Dog.glb').then(function (blaze) {
        scene.add(blaze.scene);
        rotatingGroups.push(blaze.scene);
        blaze.meshesToDispose.forEach(mesh => meshes.push(mesh));
        //animationMixers.push(createAnimationMixer(blaze));
    });
