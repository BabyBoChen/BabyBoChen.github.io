...
(function main() {
    ...
    loadObject3D('Mannequin_woman.glb').then(function (woman) {
        scene.add(woman.scene);
        rotatingGroups.push(woman.scene);
        woman.meshesToDispose.forEach(mesh => meshes.push(mesh));
        animationMixers.push(createAnimationMixer(woman));
    });
